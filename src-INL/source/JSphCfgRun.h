...
public:
  ...
  int SlipMode;         ///<Slip mode for mDBC: 0:None, 1:DBC vel=0, 2:No-slip, 3:Free slip, 4: frictional slip - Soleimani method; 5: frictional slip - Zhan method. 6:No slip - Zhan method. 7: Free slip - Zhan method(default=1).
