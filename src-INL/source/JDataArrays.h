...
protected:
  ...
  void ReindexData(unsigned sreindex,const unsigned *reindex,unsigned ndata,bool     *data,bool     *aux)const{ TReindexData<bool>    (sreindex,reindex,ndata,data,aux); }
...
public:
  ...
  unsigned AddArray(std::string fullname,unsigned count,const bool     *ptr,bool delptr=false){ return(AddArray(fullname,TypeBool   ,count,(void*)ptr,delptr)); }
  ...
  unsigned CreateArrayBool   (std::string fullname,unsigned count,bool defvalue=true,bool     value=0          ,bool delptr=true){ return(AddArray(fullname,count,NewArrayBool   (count,defvalue,value),delptr)); }
  ...
  bool*     CreateArrayPtrBool   (std::string fullname,unsigned count,bool defvalue=true,bool     value=0          ,bool delptr=true){ return((bool*)    GetArrayBool   (CreateArrayBool   (fullname,count,defvalue,value,delptr))); } 
  ...
  const bool*     GetArrayBool   (unsigned idx,unsigned count=0)const{ return((bool*    )GetArrayPtr(idx,TypeBool   ,count)); }
  ...
  const bool*     GetArrayBool   (const std::string &keyname,unsigned count=0)const{ return((bool*    )GetArrayPtr(keyname,TypeBool    ,count)); }
...
public:
  ...
  static bool*     NewArrayBool   (unsigned count,bool defvalue=false,bool     value=0);
